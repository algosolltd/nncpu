...
def summarize(report: CPUReport) -> dict:
    ...
    return {
        ...
        "prefetch_redundant": report.prefetch_redundant,
        "prefetch_used": report.prefetch_used,
        "prefetch_accuracy": report.prefetch_accuracy,
        "prefetch_coverage": report.prefetch_coverage,
        "prefetch_timeliness": report.prefetch_timeliness,
        "prefetch_late": report.prefetch_late,
        "prefetch_dropped": report.prefetch_dropped,
        "prefetch_useful_hits": report.prefetch_useful_hits,
        "prefetch_pollution_misses": report.prefetch_pollution_misses,
        "prefetch_pollution_rate": report.prefetch_pollution_rate,
        "demand_only_hits": report.demand_only_hits,
        "demand_only_misses": report.demand_only_misses,
